# Velden toevoegen aan een Word-rapportlay-out
...
> [!NOTE]  
> U kunt geen ingebouwde rapportlay-outs wijzigen.

## Het aangepaste XML-onderdeel voor het rapport openen in Word  
...
2. Geef het tabblad **Ontwikkelaar** weer in het lint van Microsoft Word.  
     ...
     Het tabblad **Ontwikkelaar** wordt standaard niet weergegeven in het lint.
  
3. Kies op het tabblad **Ontwikkelaar** de optie **deelvenster XML-toewijzing**.  
  
4. Kies in het deelvenster **XML-toewijzing**, in de vervolgkeuzelijst **Aangepast XML-onderdeel** het aangepaste XML-onderdeel voor Business Central rapport, dat meestal het laatste in de lijst is. De naam van het aangepaste XML-gedeelte heeft de volgende indeling:  
  
     urn:microsoft-dynamics-nav/reports/*report_name*/*ID*  
  
     *report_name* is de naam die is toegewezen aan het rapport.
...
> [!IMPORTANT]  
> U kunt alleen afbeeldingen toevoegen die een indeling hebben die door Word wordt ondersteund (zoals .bmp, .jpeg en .png). Als u een afbeelding toevoegt met een indeling die niet door Word wordt ondersteund, treedt een fout op wanneer u het rapport uitvoert vanuit de Business Central client.  
...
Word-rapportlay-outs worden gemaakt met *aangepaste XML-onderdelen*. Een aangepast XML-onderdeel van een rapport bestaat uit elementen die corresponderen met de gegevensitems, kolommen en labels die de gegevensset van het rapport vormen. Het aangepaste XML-onderdeel wordt gebruikt om de gegevens in een rapport toe te wijzen wanneer het rapport wordt uitgevoerd.
...
|`..<Labels>`<br /><br /> `....<ColumnNameCaption>ColumnNameCaption</ColumnNameCaption>`<br /><br /> `....<LabelName>LabelCaption</LabelName>`<br /><br /> `..</Labels>`|Bevat alle labels voor het rapport. <br />-   Labelelementen die gerelateerd zijn aan kolommen, hebben de indeling `<ColumnNameCaption>ColumnNameCaption</ColumnNameCaption>`.<br />-  Labelelementen hebben de indeling `<LabelName>LabelName</LabelName`.<br />-   Labels worden in alfabetische volgorde weergegeven.|  
|`..<DataItem1>`<br /><br /> `....<DataItem1Column1>DataItem1Column1</DataItem1Column1>`|Gegevensitem en kolommen. van het hoogste niveau Kolommen worden in alfabetische volgorde weergegeven.|  
...
In Word opent u het aangepaste XML gedeelte in het deelvenster **XML-toewijzing** en gebruikt u het deelvenster om elementen toe te wijzen aan inhoudsbesturingselementen in het Word-document. Het deelvenster **XML-toewijzing** is toegankelijk vanaf het tabblad **Ontwikkelaar** voor meer informatie).  
