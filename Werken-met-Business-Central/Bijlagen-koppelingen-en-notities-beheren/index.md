...
1. Kies het pictogram ![zoeken icon](/assets/images/zoeken.png "zoeken icon"), voer **Inkoopfacturen** in en kies de gerelateerde koppeling.
...
1. Kies het pictogram ![zoeken icon](/assets/images/zoeken.png "zoeken icon"), voer **Artikelen** in en kies de gerelateerde koppeling.
...
> [!NOTE]
> Opmerkingen over het tabblad **Bijlagen** zijn niet gerelateerd aan interne notitiefunctionaliteit, die voornamelijk wordt gebruikt om te communiceren tussen werkstroomgebruikers. Zie voor meer informatie [Werkstroomberichten instellen](../Algemene-bedrijfsfunctionaliteit/Werkstroom/Werkstromen-instellen/Werkstroomberichten-instellen/).
